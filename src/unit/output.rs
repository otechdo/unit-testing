pub mod unit {
    ...
    pub const ASSERT_SHOULD_BE_SUCCESS: &str = "The callback should have a success exist status";
    ...
    pub const ASSERT_SHOULD_BE_EXISTS: &str = "The paths has not been founded but should be exists";

    pub const ASSERT_CONTAINS: &str = "The value contains the expected data";
    pub const ASSERT_SHOULD_CONTAINS: &str =
        "The value don't contains expected data but should be contains it";
    ...
    pub const ASSERT_SHOULD_BE_NOT_CONTAINS: &str = "The value contains the data and should be not";
