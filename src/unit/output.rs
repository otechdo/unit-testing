pub mod unit {
    ...
    pub const ASSERT_SHOULD_BE_SUCCESS: &str =
        "The callback should have a success exit status code";
    pub const ASSERT_SHOULD_BE_FAIL: &str =
        "The callback should be have a failure exit status code";
